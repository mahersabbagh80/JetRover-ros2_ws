...
# @data:2024/02/28
# @author:aiden
# 巡线清障(line follow obstacle clearance)
import os
import cv2
import time
import math
...
MAX_SCAN_ANGLE = 240  # 激光的扫描角度,去掉总是被遮挡的部分degree(the scanning angle of the laser, excluding the obstructed parts consistently, in degrees)
