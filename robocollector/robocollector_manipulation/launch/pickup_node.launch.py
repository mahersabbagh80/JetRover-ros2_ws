#!/usr/bin/env python3
"""
Launch file for RoboCollector Pickup Node
...
def launch_setup(context):
    ...
    if compiled == "True":
        package_path = get_package_share_directory("robocollector_manipulation")
    else:
        package_path = (
            "/home/maher/JetRover/ros2_ws/robocollector/robocollector_manipulation"
        )

    config_file = os.path.join(package_path, "config", "pickup_params.yaml")
